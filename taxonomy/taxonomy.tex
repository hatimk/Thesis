			...
			\begin{table}[th]
				...
				\centerline{
					\begin{tabular}{|c|c|c|c|c|}
						\hline
						\textbf{TTP} & \textbf{Locutionary profile} & \textbf{Illocutionary analysis} & \textbf{Perlocutionary analysis} & \textbf{Motivations} \\
						\hline
						\textbf{FLOOR\_TAKING\_IMPL} & & Listen to me! & Grab attention & Desire to start a conversation \\
						\hline
					\end{tabular}
				}
