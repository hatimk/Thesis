...
% équivalent à \usepackage{palatino}
\usepackage{mathpazo} 
...
%\refname a References Références 
...
%\newcommand\todo[1]{[\textcolor[rgb]{0,0,0}{\textbf{à faire:} \textit{#1}}]}
\newcommand\todo[1]{ [\textcolor[rgb]{0.5,0,0}{\textbf{à faire:} #1}] }
%\newcommand\todo[1]{}
%\newcommand\tocite[1]{[\textcolor[rgb]{0,0,0}{\textbf{à citer:} \textit{#1}}]}
\newcommand\tocite[1]{[\textcolor[rgb]{0,0.5,0}{\textbf{à citer:} #1}]}
%\newcommand\tocite[1]{}
...
\usepackage{multibib}
\newcites{publis}{List of publications}
